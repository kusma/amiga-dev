...
struct _SVCXPRT;
typedef struct _SVCXPRT SVCXPRT;
...
struct _SVCXPRT {
	...
	struct xp_ops {
	    bool_t	(*xp_recv)(SVCXPRT *xprt, struct rpc_msg *msg);	 /* receive incomming requests */
	    enum xprt_stat (*xp_stat)(SVCXPRT *xprt); /* get transport status */
	    bool_t	(*xp_getargs)(SVCXPRT *xprt, xdrproc_t xdr_args, caddr_t args_ptr); /* get arguments */
	    bool_t	(*xp_reply)(SVCXPRT *xprt, struct rpc_msg *msg);	 /* send reply */
	    bool_t	(*xp_freeargs)(SVCXPRT *xprt, xdrproc_t xdr_args, caddr_t args_ptr);/* free mem allocated for args */
	    void	(*xp_destroy)(SVCXPRT *xprt); /* destroy this struct */
	} *xp_ops;
 ...
 */
extern bool_t	svc_register(SVCXPRT *xprt, u_long prog, u_long vers, void (*dispatch )(struct svc_req *, SVCXPRT *), int protocol);
...
extern void	svcerr_progvers(SVCXPRT *xprt, u_long low_vers, u_long high_vers);
